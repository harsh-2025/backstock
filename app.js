...
// const nsetools = require('nsetools');
require('dotenv').config();

const path = require("path");
const mongokey = process.env.MONGO_URL;
const polygon = process.env.polygonApiKey;
const { TimeSeries } = require('alphavantage');
// const { AlphaVantageAPI } = require('alpha_vantage_api');
...
// const polygonApiKey = 'i8_KXMFRYbuDArWkBnCkTWzibpDncO0b';
...
// https://www.google.com/finance/quote/GANDHAR:NSE?authuser=0
